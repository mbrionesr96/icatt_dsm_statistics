...
out_subset  = regsubsets(y ~ ., data = X, nvmax = p) # with 'nvmax' I can also fix the maximum number of predictors (q) that can be included
...
y = ifelse(breast$Classification == 1, 0, 1)
...
out_subset$Subsets # these are the q best models with their AICs
